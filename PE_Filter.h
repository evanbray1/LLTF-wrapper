...
//! Gets the availability of the broadband mode (no filtering).
//! @param[in] peHandle Handle to the resource
//! @return A non-zero value is returned if available, otherwise zero is returned
PEFILTERSDK_API int PE_HasBroadband(CPE_HANDLE peHandle);

//! Gets the status of the broadband mode (no filtering).
//! @param[in] peHandle Handle to the resource
//! @return A non-zero value is returned if in broadband mode, otherwise zero is returned
PEFILTERSDK_API int PE_IsBroadband(CPE_HANDLE peHandle);

//! Sets the system in broadband mode (no filtering).
//! @param[in] peHandle Handle to the resource
//! @return Error code
PEFILTERSDK_API PE_STATUS PE_SetBroadband(PE_HANDLE peHandle);
...
//! Gets the availability of the motorized harmonic filter accessory.
//! Obsolete for modern LLTFs, these have a non-motorized harmonic filter
//! that cannot be individually controlled.
//! @param[in] peHandle Handle to the resource
//! @return A non-zero value is returned if available, otherwise zero is returned
PEFILTERSDK_API int PE_HasHarmonicFilter(CPE_HANDLE peHandle);

//! Gets the status of the motorized harmonic filter accessory.
//! Obsolete for modern LLTFs, these have a non-motorized harmonic filter
//! that cannot be individually controlled.
//! @param[in] peHandle Handle to the resource
...
//! Sets the status of the motorized harmonic filter accessory.
//! Obsolete for modern LLTFs, these have a non-motorized harmonic filter
//! that cannot be individually controlled.
//! @param[in] peHandle Handle to the resource
